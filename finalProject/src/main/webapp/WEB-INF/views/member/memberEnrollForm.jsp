   ...
   //아이디 중복확인
     ...
     $('form').on('submit',function(){
         ...
         if(validAll == true){ // 유효성 모두 통과
            alert('SAMSAM AUCTION에 오신것을 환영합니다.');      
         } else{
            alert('정보를 다시 확인하세요.')
         }
       });
...
<body>
   ...
   <div class="container">
            ...
            <div class="col-sm-6 col-md-offset-3">
                <form action="insert.me" method="post" role="form" id="usercheck" name="member">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="mem_pw2" name="userPw2" placeholder="Confirm Password">
...
<div class="form-group">                   
<input class="form-control" style="width: 40%; display: inline;" placeholder="우편번호" name="addressNum" id="mem_oaddress" type="text" readonly="readonly" >
    <button type="button" class="btn btn-primary" onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>                               
</div>

<div class="form-group">
    <input class="form-control" style="top: 5px;" placeholder="도로명 주소" name="address" id="mem_address" type="text" readonly="readonly" />
</div>

<div class="form-group">
    <input class="form-control" placeholder="상세주소" name="addressDetail" id="mem_detailaddress" type="text"  />
</div>
