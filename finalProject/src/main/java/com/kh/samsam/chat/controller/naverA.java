...
@Controller
public class naverA {
	private static String secretKey = "dVFOYmxjTldPbVJ0QktBTlp2SGVodmNrdUZUcXZmQ04=";
    private static String apiUrl = "https://8rclnrd5gv.apigw.ntruss.com/chat/chatbot/";
    ...
    public String sendMessage(@Payload String chatMessage) throws IOException
    {
        ...
        if(responseCode==200) { // 정상 호출
            ...
            try {
                ...
                chatMessage = description+"<br>"+urlAdd;
            } catch (Exception e) {
