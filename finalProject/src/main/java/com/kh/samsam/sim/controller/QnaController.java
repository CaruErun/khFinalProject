...
import com.kh.samsam.sim.model.service.QnaService;
...
//		System.out.println(qNo); //잘 되는지 체크
	...
	public ModelAndView updateForm(ModelAndView mv, int qNo) { //public ModelAndView , public String 본인이 하고싶은거로 해~
